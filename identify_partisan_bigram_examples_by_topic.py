'''
    ...
    > Reads in probability data for each party generated by "estimated_partisan_bigram_probs_from_dummies.do" 
    (probabilities and standard errors of their most partisan bigrams in speeches that do and do not evoke God)
    and calculates confidence intervals
    
    > For both Republicans and Democrats, identifies examples of partisan bigrams that have a significantly higher 
    probability of begin spoken when God has been evoked, and groups these into topics 
    (the basis of Figures 2 and 3 in the paper)
